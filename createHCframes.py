...
frames_folder = '/home/student/Desktop/CVSA_HW1_data/HCframes_1/frames'
labels_folder = '/home/student/Desktop/CVSA_HW1_data/HCframes_1/labels'
dataset_folder = '/home/student/Desktop/CVSA_HW1_data/HCframes_1/YOLOds'
...
model = YOLO('/home/student/Desktop/augmented_model.pt')  # path to the saved model
    ...
    while cap.isOpened():
        ...
        for result in results:
            ...
            for box, conf, class_id in zip(boxes, confidences, class_ids):
                ...
                if (torch.min(confidences) >= 0.96 and len(confidences)>1) or (len(confidences)==1 and torch.min(confidences) >= 0.99):
                    #print(conf)
