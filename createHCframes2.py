...
# Paths
source_folder = '/home/student/Desktop/CVSA_HW1_data/id_video_data'
frames_folder = '/home/student/Desktop/CVSA_HW1_data/HCframes_2/frames'
labels_folder = '/home/student/Desktop/CVSA_HW1_data/HCframes_2/labels'
dataset_folder = '/home/student/Desktop/CVSA_HW1_data/HCframes_2/YOLOds'
...
model = YOLO('/home/student/Desktop/pseudo_trained_model.pt')  # path to the saved model
    ...
    while cap.isOpened():
        ...
        for result in results:
            ...
            for box, conf, class_id in zip(boxes, confidences, class_ids):
                ...
                if (torch.min(confidences) >= 0.985 and len(confidences)>1) or (torch.min(confidences) >= 0.99 and len(confidences)==1):
                    #print(conf)
